...
INSERT INTO company(name, headquarter, industry_id) VALUES
    ('Delta Air Lines', 'Atlanta, GA', 1);

INSERT INTO job(company_id, title, frontend, languages, experience, url) VALUES
    (1, 'Senior Software Developer', 'Angular, React, Vue.js', 'TypeScript, JavaScript', 3, 'https://delta.avature.net/careers/JobDetail/Senior-Front-End-Web-Developer/20048?ref=levels.fyi&src=levels.fyi&utm_source=levels.fyi&ref=levels.fyi&utm_source=levels.fyi');
